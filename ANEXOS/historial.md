...
queremos implementar un sistema integral de gestión académica, financiera y de asistencia exclusivo para nuestra institución,
para centralizar los procesos administrativos, garantizar el cumplimiento del reglamento académico interno,
...
Como Docente,
quiero cargar notas y registrar asistencia digitalmente,
para llevar control formal y actualizado de mis comisiones.
...
quiero registrar pagos y visualizar morosidad,
para controlar el flujo financiero institucional.
...
Como sistema,
debo impedir la inscripción a materias cuando no se hayan aprobado las correlativas definidas por la institución,
